...
Deletes old backups. See: C<--keep-days>.
...
The README is generated by C<pod2text xtrabackup-helper.pl E<gt> README>
...
Jonathan Leroy E<lt>jonathan@inikup.comE<gt>
